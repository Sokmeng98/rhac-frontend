...
<template>
	<TiptapToolbarButton label="Remove table" @click="editor?.commands.deleteTable()">
	...
	<TiptapToolbarButton label="Add column before" @click="editor?.commands.addColumnBefore()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Add column after" @click="editor?.commands.addColumnAfter()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Remove column" @click="editor?.commands.deleteColumn()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Add row before" @click="editor?.commands.addRowBefore()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Add row after" @click="editor?.commands.addRowAfter()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Remove row" @click="editor?.commands.deleteRow()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
	...
	<TiptapToolbarButton label="Merge or split cell" @click="editor?.commands.mergeOrSplit()">
		<svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
			<path
